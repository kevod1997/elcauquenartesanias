// API local con el catálogo del sitio viejo (F3-D6, docs/frontend-por-fases/fases/fase-3.md), para probar / sin el backend.
...
// Después: PUBLIC_API_URL=http://localhost:4400 pnpm dev y abrí http://localhost:4321/.
